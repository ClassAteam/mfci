...
typedef enum mfci_in_suo_50x_sa_type_t {
   ...
   MFCI_IN_SUO_50X_SA_OSP_INIT,         //!< Подадрес с данными инциализации ОСП
   MFCI_IN_SUO_50X_SA_OSP_OUTER_POINTS, //!< Подадрес с данными точек контура ОСП
...
//! Слово 20 сигнализации МФЦИ (сигналы ТОПЛ, СНС, ПКР)
...
//! Слово 50 сигнализации МФЦИ (сигналы СПЗ, ПК)
typedef struct mfci_signals_word_50_b_t {
   ...
   uint16_t                          : 2; //!< Резерв
   uint16_t topl_valve_pk1_opened_kv : 1; //!< [ТОПЛ-Д140] КВ ОТКР пожарного крана ПК1 (для счетчика давления азота и сигналов режима двигателя)
   uint16_t topl_valve_pk1_closed_kv : 1; //!< [ТОПЛ-Д141] КВ ЗАКР пожарного крана ПК1 (для счетчика давления азота и сигналов режима двигателя)
   uint16_t topl_valve_pk2_opened_kv : 1; //!< [ТОПЛ-Д144] КВ ОТКР пожарного крана ПК2 (для счетчика давления азота и сигналов режима двигателя)
   uint16_t topl_valve_pk2_closed_kv : 1; //!< [ТОПЛ-Д145] КВ ЗАКР пожарного крана ПК2 (для счетчика давления азота и сигналов режима двигателя)
} mfci_signals_word_50_b_t;

//! Слово 51 сигнализации МФЦИ (сигналы ПК, БЦВМ, НО)
typedef struct mfci_signals_word_51_b_t {
   uint16_t topl_valve_pk3_opened_kv : 1; //!< [ТОПЛ-Д148] КВ ОТКР пожарного крана ПК3 (для счетчика давления азота и сигналов режима двигателя)
   uint16_t topl_valve_pk3_closed_kv : 1; //!< [ТОПЛ-Д149] КВ ЗАКР пожарного крана ПК3 (для счетчика давления азота и сигналов режима двигателя)
   uint16_t topl_valve_pk4_opened_kv : 1; //!< [ТОПЛ-Д152] КВ ОТКР пожарного крана ПК4 (для счетчика давления азота и сигналов режима двигателя)
   uint16_t topl_valve_pk4_closed_kv : 1; //!< [ТОПЛ-Д153] КВ ЗАКР пожарного крана ПК4 (для счетчика давления азота и сигналов режима двигателя)
...
//! Слово 52 сигнализации МФЦИ (сигналы БЦВМ, НО, ПБД)
...
//! Слово 53 сигнализации МФЦИ (сигналы ПБД, НГ, РСБН)
typedef struct mfci_signals_word_53_b_t {
   ...
   uint16_t rsbn_failure           : 1; //!< [РСБН-Л001] РСБН ОТКАЗ (СОСТ)
   uint16_t rsbn_failure_nl        : 1; //!< [РСБН-Л002] РСБН НАВ И ПОС ОТКАЗ (СОСТ)
   uint16_t rsbn_failure_msn       : 1; //!< [РСБН-Л003] РСБН МСН ОТКАЗ (СОСТ)
   uint16_t                        : 3; //!< Резерв
} mfci_signals_word_53_b_t;

//! Слово 54 сигнализации МФЦИ (сигналы СУПК, САС/ЦСО)
...
//! Слово сигналов инициализации РВП кадра СУО-504/506 (из раздела 2 АУР)
...
//! Слово сигналов передачи данных точек РВП кадра СУО-504/506 (из раздела 2 АУР)
typedef struct mfci_in_suo_50x_rvp_points_flag_word_b_t {
   uint16_t rvp_loading  : 1;  //!< [БП-504/506-Д208.3] Перезагрузка РВП
   uint16_t start_number : 11; //!< Номер первого элемента в массиве точек РВП points_b //(min:1 max:1500)
   uint16_t              : 4;  //!< Резерв
} mfci_in_suo_50x_rvp_points_flag_word_b_t;

//! Слово сигналов передачи данных описаний полигонов РВП кадра СУО-504/506 (из раздела 2 АУР)
typedef struct mfci_in_suo_50x_rvp_polygons_flag_word_b_t {
   uint16_t rvp_loading  : 1; //!< [БП-504/506-Д208.3] Перезагрузка РВП
   uint16_t start_number : 9; //!< Номер первого элемента в массиве описаний полигонов РВП polygons_b //(min:1 max:375)
   uint16_t              : 6; //!< Резерв
...
//! Слово параметров ОСП БП-504/506 (из раздела 2 АУР)
...
typedef struct bcvm_flag_word_1_b_t {
   uint16_t magn_course_selected  : 1; //!< [БЦВМ-Д001] Выбран магнитный курс
   uint16_t vnav_active           : 1; //!< [БЦВМ-Д002] Режим вертикальной навигации выполняется
   uint16_t true_course_selected  : 1; //!< [БЦВМ-Д003] Выбран истинный курс
   uint16_t grid_course_selected  : 1; //!< [БЦВМ-Д004] Выбран этапный курс
...
typedef struct bcvm_valid_word_1_b_t {
   uint16_t magn_course       : 1; //!< Д[БЦВМ-А003] Достоверность магнитного курса
   uint16_t true_course       : 1; //!< Д[БЦВМ-А004] Достоверность истинного курса
   uint16_t magn_pu_selected  : 1; //!< Д[БЦВМ-А005] Достоверность магнитного заданного путевого угла или заданного курса
   uint16_t true_pu           : 1; //!< Д[БЦВМ-А007] Достоверность истинного путевого угла
   uint16_t delta_z           : 1; //!< Д[БЦВМ-А008] Достоверность ЛБУ
   uint16_t magn_pu           : 1; //!< Д[БЦВМ-А009] Достоверность магнитного путевого угла
   ...
   uint16_t azimuth_selected  : 1; //!< Д[БЦВМ-А012] Достоверность заданного азимута VOR (магнитного) или РСБН (истинного)
...
typedef struct bcvm_valid_word_2_b_t {
   ...
   uint16_t wind_angle        : 1; //!< Д[БЦВМ-А022] Достоверность метеорологического направления ветра
   ...
   uint16_t grid_course       : 1; //!< Д[БЦВМ-А035] Достоверность этапного курса
...
typedef struct mfci_in_tar_status_word_b_t {
   ...
   uint16_t load_status      : 2; //!< Состояние чтения таблицы тарировки выбранного УКС (0-чтение не активно, 1-ошибка чтения, 2-завершение чтения) //(min:0 max:2)
   uint16_t save_status      : 2; //!< Состояние записи таблицы тарировки выбранного УКС (0-запись не активна, 1-ошибка записи, 2-завершение записи) //(min:0 max:2)
...
typedef struct mfci_point_id_5_b_t {
   ...
   uint16_t waypoint_selected : 1;  //!< Признак исполняемого ППМ маршрута активного маршрута
} mfci_point_id_5_b_t;
...
typedef struct mfci_active_path_legs_id_1_b_t {
   ...
   uint16_t type_1          : 4; //!< Тип следующего участка для точки 1 (plan_leg_type_t) //(min:0 max:9)
   uint16_t                 : 1; //!< Резерв
...
typedef struct mfci_active_path_legs_id_2_b_t {
   uint16_t type_2 : 4; //!< Тип следующего участка для точки 2 (plan_leg_type_t) //(min:0 max:9)
   uint16_t type_3 : 4; //!< Тип следующего участка для точки 3 (plan_leg_type_t) //(min:0 max:9)
   uint16_t type_4 : 4; //!< Тип следующего участка для точки 4 (plan_leg_type_t) //(min:0 max:9)
   uint16_t type_5 : 4; //!< Тип следующего участка для точки 5 (plan_leg_type_t) //(min:0 max:9)
...
//! Слово сигналов УПР для кадра ТАР (слово 1)
...
//! Слово сигналов УПР для кадра ТАР (слово 2)
typedef struct upr_flag_word_tar_2_b_t {
   uint16_t command_id               : 2; //!< Команда МФЦИ. Код команды (0-нет, 1-чтение таблицы, 2-запись таблицы, 3-фиксирование кода АЦП)
   uint16_t command_uks_number       : 3; //!< Команда МФЦИ. Номер УКС //(min:1 max:4)
   uint16_t command_parameter_number : 4; //!< Команда МФЦИ. Номер тарируемого параметра //(min:1 max:10)
   uint16_t command_code_number      : 3; //!< Команда МФЦИ. Номер узловой точки //(min:1 max:7)
   uint16_t                          : 4; //!< Резерв
} upr_flag_word_tar_2_b_t;

//! Слово сигналов УПР для кадра ТАР (слово 3)
typedef struct upr_flag_word_tar_3_b_t {
   uint16_t command_counter : 16; //!< Команда МФЦИ. Счетчик команд СОИ для тарировки УКС //(min:1 max:65535)
...
typedef union upr_flag_word_format_b_t {
   ...
   upr_flag_word_tar_1_b_t      tar_1_b;      //!< Управляющие сигналы МФЦИ для кадра ТАР (слово 1)
   upr_flag_word_tar_2_b_t      tar_2_b;      //!< Управляющие сигналы МФЦИ для кадра ТАР (слово 2)
   upr_flag_word_tar_3_b_t      tar_3_b;      //!< Управляющие сигналы МФЦИ для кадра ТАР (слово 3)
...
typedef struct mfci_in_sa_1_b_t {
   ...
   mfci_signals_word_20_b_t signals_word_20_b; //!< Слово 20 сигнализации МФЦИ (сигналы ТОПЛ, СНС, ПКР)
...
typedef struct mfci_in_sa_2_b_t {
   ...
   mfci_signals_word_50_b_t    signals_word_50_b;    //!< Слово 50 сигнализации МФЦИ (сигналы СПЗ, ПК)
   mfci_signals_word_51_b_t    signals_word_51_b;    //!< Слово 51 сигнализации МФЦИ (сигналы ПК, БЦВМ, НО)
   mfci_signals_word_52_b_t    signals_word_52_b;    //!< Слово 52 сигнализации МФЦИ (сигналы БЦВМ, НО)
   mfci_signals_word_53_b_t    signals_word_53_b;    //!< Слово 53 сигнализации МФЦИ (сигналы ПБД, НГ, РСБН)
   mfci_signals_word_54_b_t    signals_word_54_b;    //!< Слово 54 сигнализации МФЦИ (сигналы СУПК, САС/ЦСО)
...
typedef struct mfci_in_sa_4_b_t {
   ...
   uint16_t                 bcvm_grid_course;            //!< [БЦВМ-А035] Курс этапный //(min:0 max:360 signed:4 bits:5..19 msb:180°)
...
typedef struct mfci_in_sa_13_b_t {
   ...
   uint16_t                bcvm_v1_continued;         //!< [БЦВМ-А016] Скорость принятия решения на разбеге V1 (продолженная) //(min:150 max:390 signed:4 bits:5..19 msb:948.224 км/ч)
   uint16_t                bcvm_v1;                   //!< [БЦВМ-А017] Скорость принятия решения на разбеге V1 (прерванная) //(min:150 max:390 signed:4 bits:5..19 msb:948.224 км/ч)
...
typedef struct mfci_in_sa_21_b_t {
   uint16_t                 bcvm_vr;                    //!< [БЦВМ-А018] Скорость начала подъема передней стойки шасси VR //(min:250 max:390 signed:4 bits:5..19 msb:948.224 км/ч)
   uint16_t                 bcvm_v2;                    //!< [БЦВМ-А019] Безопасная скорость на взлете V2 //(min:300 max:450 signed:4 bits:5..19 msb:948.224 км/ч)
...
typedef struct mfci_in_tar_b_t {
   ...
   uint16_t                        command_counter;     //!< Значение счетчика последней выполненной команды СОИ (квитанция на upr_flag_word_tar_3_b_t::command_counter) //(min:1 max:65535 bits:4..19 lsb:1)
} mfci_in_tar_b_t;
...
typedef struct mfci_in_suo_50x_3_b_t {
   ...
   uint16_t                    bp_m_g_to_gx_1;                 //!< [БП-504/506-А200.1] Матрица поворота в косую проекцию для РВП, строка 1, столбец 1 //(min:-1 max:1 signed:4 bits:5..19 msb:0.5)
   uint16_t                    bp_m_g_to_gx_2;                 //!< [БП-504/506-А200.1] Матрица поворота в косую проекцию для РВП, строка 2, столбец 1 //(min:-1 max:1 signed:4 bits:5..19 msb:0.5)
   uint16_t                    bp_m_g_to_gx_3;                 //!< [БП-504/506-А200.1] Матрица поворота в косую проекцию для РВП, строка 1, столбец 2 //(min:-1 max:1 signed:4 bits:5..19 msb:0.5)
   uint16_t                    bp_m_g_to_gx_4;                 //!< [БП-504/506-А200.1] Матрица поворота в косую проекцию для РВП, строка 2, столбец 2 //(min:-1 max:1 signed:4 bits:5..19 msb:0.5)
   uint16_t                    bp_proj_c_lat_high;             //!< [БП-504/506-А200.2] Широта центра гномонической проекции для РВП, старшее слово (ЦСР пи/2 рад) //(min:-1.570796326795 max:1.570796326795 signed:4 bits:5..19 msb:1.570796326795 рад)
   uint16_t                    bp_proj_c_lat_low;              //!< [БП-504/506-А200.2] Широта центра гномонической проекции для РВП, младшее слово
   uint16_t                    bp_proj_c_lon_high;             //!< [БП-504/506-А200.2] Долгота центра гномонической проекции для РВП, старшее слово (ЦСР пи/2 рад) //(min:-3.14159265359 max:3.14159265359 signed:4 bits:5..19 msb:1.570796326795 рад)
   uint16_t                    bp_proj_c_lon_low;              //!< [БП-504/506-А200.2] Долгота центра гномонической проекции для РВП, младшее слово
...
typedef struct mfci_in_suo_50x_rvp_init_b_t {
   ...
   mfci_in_suo_50x_rvp_init_flag_word_b_t flag_word_b; //!< Слово сигналов инициализации РВП
...
typedef struct mfci_in_suo_50x_rvp_points_b_t {
   ...
   mfci_in_suo_50x_rvp_points_flag_word_b_t flag_word_b;  //!< Слово сигналов передачи данных точек РВП
...
typedef struct mfci_in_suo_50x_rvp_polygons_b_t {
   ...
   mfci_in_suo_50x_rvp_polygons_flag_word_b_t flag_word_b;    //!< Слово сигналов передачи данных описаний полигонов РВП
...
//! Входное сообщение МФЦИ c данными инциализации ОСП (из раздела 2 АУР), МКИО-3.2 (12.5 Гц)
typedef struct mfci_in_suo_50x_osp_init_b_t {
   uint16_t                               sa_type;     //!< Идентификатор подадреса (MFCI_IN_SUO_50X_SA_OSP_INIT)
   mfci_in_suo_50x_osp_init_flag_word_b_t flag_word_b; //!< Слово параметров ОСП
...
typedef union mfci_in_suo_50x_4_20_b_t {
   ...
   mfci_in_suo_50x_osp_init_b_t         osp_init_b;         //!< Данные инициализации ОСП (из раздела 2 АУР)
