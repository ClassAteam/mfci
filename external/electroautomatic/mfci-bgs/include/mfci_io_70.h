...
//! Слово 53 сигнализации МФЦИ (сигналы НГ, СНС, РСБН, СУПК)
...
typedef struct mfci_in_sa_2_b_t {
   ...
   mfci_signals_word_52_b_t    signals_word_52_b;    //!< Слово 52 сигнализации МФЦИ (сигналы БЦВМ, НО, ПБД)
   mfci_signals_word_53_b_t    signals_word_53_b;    //!< Слово 53 сигнализации МФЦИ (сигналы НГ, СНС, РСБН, СУПК)
