...
int main()
{
    ...
    shm_in_holder_ctor(in_holder1, "mfci_shm_input1");

    esvo_in_data_init(in_holder1->data);

    shm_out_holder_t* out_holder1 = shm_out_holder_new();
    shm_out_holder_ctor(out_holder1, "mfci_shm_output1");

    shm_buttons_holder_t* buttons_holder1 = shm_buttons_holder_new();
    shm_buttons_holder_ctor(buttons_holder1, "mfci_shm_buttonsput1");
